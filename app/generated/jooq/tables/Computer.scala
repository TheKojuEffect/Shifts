...
)
{
   ...
   */
  val ID : TableField[ComputerRecord, Long] = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), "")

  /**
   * The column <code>public.computer.name</code>.
   */
  val NAME : TableField[ComputerRecord, String] = createField("name", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), "")

  /**
   * The column <code>public.computer.introduced</code>.
   */
  val INTRODUCED : TableField[ComputerRecord, Timestamp] = createField("introduced", org.jooq.impl.SQLDataType.TIMESTAMP, "")

  /**
   * The column <code>public.computer.discontinued</code>.
   */
  val DISCONTINUED : TableField[ComputerRecord, Timestamp] = createField("discontinued", org.jooq.impl.SQLDataType.TIMESTAMP, "")

  /**
   * The column <code>public.computer.company_id</code>.
   */
  val COMPANY_ID : TableField[ComputerRecord, Long] = createField("company_id", org.jooq.impl.SQLDataType.BIGINT, "")
