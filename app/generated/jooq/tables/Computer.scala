...
)
{
   ...
   */
  val INTRODUCED : TableField[ComputerRecord, LocalDateTime] = createField(DSL.name("introduced"), org.jooq.impl.SQLDataType.LOCALDATETIME, "")

  /**
   * The column <code>public.computer.discontinued</code>.
   */
  val DISCONTINUED : TableField[ComputerRecord, LocalDateTime] = createField(DSL.name("discontinued"), org.jooq.impl.SQLDataType.LOCALDATETIME, "")
  ...
  override def getIndexes : List[ Index ] = {
    return Arrays.asList[ Index ](Indexes.IX_COMPUTER_COMPANY_1)
  }
